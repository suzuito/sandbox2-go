...
import (
	...
	"github.com/suzuito/sandbox2-go/blog/infra/bgcp"
	"github.com/suzuito/sandbox2-go/blog/infra/bgithub"
	"github.com/suzuito/sandbox2-go/blog/infra/bmysql"
	"github.com/suzuito/sandbox2-go/blog/usecase"
	"github.com/suzuito/sandbox2-go/blog/usecase/markdown2html"
	"github.com/suzuito/sandbox2-go/blog/web"
	"golang.org/x/oauth2"
...
func NewUsecaseImpl(ctx context.Context) (*usecase.UsecaseImpl, *Environment, *web.WebSetting, error) {
	...
	s := web.WebSetting{
		...
		DirPathTemplates: "blog/web/templates",
		DirPathCSS:       "blog/web/css",
		DirPathImages:    "blog/web/images",

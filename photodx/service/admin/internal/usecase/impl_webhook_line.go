...
func (t *Impl) ProcLINEMessagingAPIWebhook(
	...
	for _, event := range message.Events {
		if err := t.ProcLINEMessagingAPIWebhook_anyEvent(ctx, photoStudioID, event); err != nil {
...
func (t *Impl) ProcLINEMessagingAPIWebhook_anyEvent(
	...
	case entity.LINEWebhookEventTypeFollow:
		return t.procLINEMessagingAPIWebhook_Follow(ctx, photoStudioID, eventBytes)
	case entity.LINEWebhookEventTypeMessage:
		return t.procLINEMessagingAPIWebhook_Message(ctx, photoStudioID, eventBytes)
	}
	return nil
}

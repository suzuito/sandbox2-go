...
// Source: crawler/pkg/entity/notifier/notifier.go
//
// Generated by this command:
//
//	mockgen -source crawler/pkg/entity/notifier/notifier.go -package notifier -destination crawler/pkg/entity/notifier/notifier_mock.go
//
...
func (m *MockNotifier) NewEmptyTimeSeriesData() timeseriesdata.TimeSeriesData {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewEmptyTimeSeriesData")
	ret0, _ := ret[0].(timeseriesdata.TimeSeriesData)
	return ret0
}

// NewEmptyTimeSeriesData indicates an expected call of NewEmptyTimeSeriesData.
func (mr *MockNotifierMockRecorder) NewEmptyTimeSeriesData() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewEmptyTimeSeriesData", reflect.TypeOf((*MockNotifier)(nil).NewEmptyTimeSeriesData))
}

...
func Test(t *testing.T) {
	...
	parser := ConnpassParser{}
	data, err := parser.Do(ctx, bytes.NewBuffer([]byte(bodyConnpassParserTest)), nil)
	if err != nil {
		t.Fail()
		return
	}
	assert.Equal(t, crawler.ParserID("connpass"), parser.ID())

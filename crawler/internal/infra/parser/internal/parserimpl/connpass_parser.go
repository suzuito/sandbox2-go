...
type ConnpassParser struct {
}

func (t *ConnpassParser) ID() crawler.ParserID {
	return "connpass"
}

func (t *ConnpassParser) Do(ctx context.Context, r io.Reader, _ crawler.CrawlerInputData) ([]timeseriesdata.TimeSeriesData, error) {

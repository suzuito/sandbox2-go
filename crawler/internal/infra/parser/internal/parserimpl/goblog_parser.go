...
type GoBlogParser struct {
	BaseURLGoBlog string
}

func (t *GoBlogParser) ID() crawler.ParserID {
	return "goblog"
}

func (t *GoBlogParser) Do(ctx context.Context, r io.Reader, _ crawler.CrawlerInputData) ([]timeseriesdata.TimeSeriesData, error) {

...
func NewDiscordConnpassEventNotifier(def *notifier.NotifierDefinition, setting *factorysetting.NotifierFactorySetting) (notifier.Notifier, error) {
	n := notifierimpl.DiscordConnpassEventNotifier{
